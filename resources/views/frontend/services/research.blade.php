...
@section('title', 'Layanan Penelitian')

@section('content')
<div class="page-header">
    <div class="container">
        <h1>Layanan Penelitian</h1>
...
<section class="py-5">
    <div class="container">
        ...
        <div class="alert alert-info">
            <i class="bi bi-info-circle"></i> Informasi layanan penelitian belum tersedia.
        </div>
        @endif
    </div>
</section>
