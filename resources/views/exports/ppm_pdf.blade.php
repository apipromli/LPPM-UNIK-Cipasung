...
<head>
<meta charset="UTF-8">
<title>Data PPM Internal LPPM UNIK Cipasung</title>
<style>
...
<body>
<div class="header">
    <h2>Data Pengabdian kepada Masyarakat (PPM) Internal</h2>
    <p>LPPM Universitas Islam KH. Ruhiyat Cipasung &nbsp;|&nbsp; Dicetak: {{ date('d F Y') }}</p>
</div>
<div class="meta">Total: {{ count($ppms) }} data</div>
<table>
    <thead>
        <tr>
            <th style="width:30px;">No</th>
            <th style="width:50px;">Tahun</th>
            <th style="width:160px;">Nama Pelaksana</th>
