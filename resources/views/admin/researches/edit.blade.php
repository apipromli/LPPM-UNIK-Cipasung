                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="researcher"
                                ...
                                value="{{ old('researcher', $research->researcher) }}" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="scheme"
                                ...
                                <option value="{{ old('scheme', $research->scheme) }}">Pilih Skema</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="year"
                                ...
                                value="{{ old('year', date('Y')), $research->year }}" required>
                        </div>
